...
@interface HWWordViewController ()

@end

@implementation HWWordViewController
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.textLabel.text = [NSString stringWithFormat:@"这是段子cell的第%zd行",indexPath.row];
