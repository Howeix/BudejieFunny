...
@interface HWVoiceViewController ()

@end

@implementation HWVoiceViewController
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.textLabel.text = [NSString stringWithFormat:@"这是声音cell的第%zd行",indexPath.row];
